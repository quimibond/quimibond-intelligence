  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <PageHeader
          title="Dashboard"
          description="Vista ejecutiva de inteligencia comercial"
        />
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          icon={Bell}
          description={`${kpi.open_alerts} alertas abiertas en total`}
        />
        <StatCard
          title="Acciones Pendientes"
          value={kpi.pending_actions}
          icon={CheckSquare}
          description={`${kpi.overdue_actions} vencidas`}
        />
        <StatCard
          title="Contactos en Riesgo"
          value={kpi.at_risk_contacts}
          icon={Users}
          description={`de ${kpi.total_contacts} contactos`}
        />
        <StatCard
