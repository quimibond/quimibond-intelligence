  ...
  return (
    <html lang="es-MX" suppressHydrationWarning>
      <head>
        ...
        />
        {/* Prevent flash: apply table density before paint. */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var d=localStorage.getItem("qb:table-density");if(d==="compact"||d==="normal"){document.documentElement.setAttribute("data-table-density",d);}}catch(e){}})()`,
          }}
        />
      </head>
      <body>
