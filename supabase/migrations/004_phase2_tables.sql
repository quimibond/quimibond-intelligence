...
--   chat_memory, chat_feedback, feedback_signals,
--   communication_patterns, company_odoo_snapshots,
--   account_summaries, response_metrics, prediction_outcomes,
--   system_learning, daily_summaries, sync_state, events,
--   alert_type_catalog, topic_category_catalog,
--   alert_calibration_log, learning_effectiveness
-- ============================================================
