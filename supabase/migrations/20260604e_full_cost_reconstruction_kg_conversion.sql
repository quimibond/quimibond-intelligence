-- 2026-06-04e: get_full_cost_reconstruction costea también la tela vendida en
-- kg: la convierte a metros-equivalentes (product_uom_conversion) y le aplica
-- el factor $/metro. Productos sin conversión (desperdicio/servicio/pieza)
-- quedan solo con MP (factor 0).
